//selector:请求的内容；context:请求的范围，即在某个范围内请求内容
(function(window){
...
//做动画的方法：只能设置数字类型的
        ...
        //50:设置animate动画样式:三个参数：终值样式，时间，回调函数；
    ...
    //45:extend:对对象的扩展,后面的对象值，把前面的给覆盖掉
    ...
    //46：formParams:将对象转化成字符串：先转成数组，再转成字符串：
