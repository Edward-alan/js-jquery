...
scrollTop:function(){     //距离顶部的距离
	var scrollTop = document.documentElement.scrollTop || document.body.scrollTop;
},

};
jQuery.extend = function(){    //对对象的扩展,把后面的对象扩展成一个对象
	var target = arguments[0];    //取到第一个
	for(var i=1;i<arguments.length;i++){  //参数进行遍历arguments
 ...
 jQuery.formParams = function(data){     //将对象转字符串
 	var arr = [];
 	for(var key in data){
